...
trng <- read.table("train/X_train.txt")
tst <- read.table("test/X_test.txt")
X <- rbind(trng, tst)

trng <- read.table("train/subject_train.txt")
tst <- read.table("test/subject_test.txt")
S <- rbind(trng, tst)

trng <- read.table("train/y_train.txt")
tst <- read.table("test/y_test.txt")
Y <- rbind(trng, tst)
